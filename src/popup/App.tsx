      ...
      <div className="popup-content">
        <div className="switch-list">
          ...
          <div className="section-group">
            ...
            <label className="switch-row switch-row-child">
              <span className="switch-label">Block Premium</span>
              <span className="switch switch-small">
                <input
                  type="checkbox"
                  checked={settings.networkPremium}
                  onChange={() => toggleSection('networkPremium')}
                />
                <span className="slider"></span>
              </span>
            </label>
            ...
            <label className="switch-row switch-row-child">
              <span className="switch-label">Block suggestions</span>
              <span className="switch switch-small">
                <input
                  type="checkbox"
